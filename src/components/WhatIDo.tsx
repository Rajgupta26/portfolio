        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Crafting performant, responsive mobile experiences. Developing and maintaining cross-platform applications using modern frameworks.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Deploying scalable cloud solutions on AWS and transforming raw datasets into interactive, actionable dashboards using Power BI.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
